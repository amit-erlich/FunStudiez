...
//       settingArray.push(initializeExampleSettingArray('R', 1, 7));
//       settingArray.push(initializeExampleSettingArray('R', 3, 4));
  
//       //settingArray.push(initializeExampleSettingArray('S', 1, 4));
//       settingArray.push(initializeExampleSettingArray('S', 2, 16));
//       settingArray.push(initializeExampleSettingArray('S', 3, 30, 3));
  
//       settingArray.push(initializeExampleSettingArray('O', 1, 1));
//       settingArray.push(initializeExampleSettingArray('O', 2, 7));
//       settingArray.push(initializeExampleSettingArray('O', 3, 7));
  
//       const additionatText = ['Read formula sheet', 'Add 3 N=NP sentences', 'Mix test answers'];
